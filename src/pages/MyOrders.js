...
const MyOrders = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 to-gray-100/50 safe-area-bottom">
      {/* Header */}
        ...
        <div className="container mx-auto px-4 py-4">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="bg-white border border-gray-200 p-3 rounded-xl hover:bg-gray-50 disabled:opacity-50 transition-all duration-200 shadow-sm hover:shadow-md active:scale-95"
            >
              {refreshing ? (
      ...
      <div className="container mx-auto px-4 py-4 pb-24">
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-1.5 mb-4 shadow-lg border border-gray-200/50">
          <div className="flex">
            {[
              ...
              <button
                key={tab.key}
                className={`flex-1 py-3 px-2 rounded-xl font-semibold transition-all duration-300 flex flex-col items-center space-y-1 text-sm ${
        ...
        <div className="bg-white/80 backdrop-blur-lg rounded-2xl p-4 mb-4 shadow-lg border border-gray-200/50">
          <div className="flex items-center justify-between mb-3">
            ...
            <button
              ...
              className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-3 py-1.5 rounded-lg text-xs font-semibold transition-all duration-200 hover:shadow-lg active:scale-95"
            >
          ...
          <div className={`transition-all duration-500 ease-in-out overflow-hidden ${
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-2">
              {[
                ...
                <button
                  key={status.key}
                  className={`p-3 rounded-xl font-medium transition-all duration-300 flex flex-col items-center space-y-2 text-xs border-2 ${
                    filter === status.key
        ...
        {(loading && orders.length === 0) && (
          <div className="flex flex-col items-center justify-center py-16">
            ...
            <p className="text-gray-600 text-sm font-medium mt-4">Loading your orders...</p>
            <p className="text-gray-400 text-xs mt-1">Getting everything ready for you</p>
          </div>
        )}
          ...
          <div className="bg-gradient-to-br from-red-50 to-red-100/50 border border-red-200 rounded-2xl p-4 mb-4 shadow-lg">
            <div className="flex items-start space-x-3">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-red-800 font-semibold text-sm">Failed to load orders</p>
                <p className="text-red-600 text-xs mt-1">{error}</p>
                <button
                  onClick={handleRefresh}
                  className="bg-red-600 text-white px-4 py-2 rounded-lg text-xs font-semibold mt-3 transition-all duration-200 hover:bg-red-700 active:scale-95"
                >
                  Try Again
                </button>
              </div>
            ...
            return (
              ...
              >
                ...
                <div className="p-4 border-b border-gray-200/60">
                    ...
                    <div className="flex items-start space-x-3 flex-1 min-w-0">
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center space-x-2 mb-1">
                          ...
                          <span className={`px-2 py-1 rounded-full text-xs font-semibold ${getOrderTypeBadge(order)}`}>
                        ...
                        {order.restaurant && (
                          <div className="flex items-center space-x-2 mt-2">
                            <div className="bg-blue-50 px-2 py-1 rounded-lg flex items-center space-x-1">
                              ...
                              <span className="text-blue-700 text-xs font-medium truncate max-w-[120px]">
                  ...
                  <div className="flex items-center justify-between mb-3">
                    <div className="flex items-center space-x-2">
                      ...
                      <span className={`px-3 py-1.5 rounded-full text-xs font-semibold ${paymentInfo.badgeClass}`}>
                  ...
                  <div className="flex justify-between items-center pt-3 border-t border-gray-200/60">
                    <div className="text-xs text-gray-600 flex items-center space-x-2">
                      {order.deliveryTime && (
                        <span className="font-medium text-gray-700 bg-gray-100 px-2 py-1 rounded-lg">
                        ...
                        <div key={item.id || index} className="flex justify-between items-start bg-white p-3 rounded-xl border border-gray-200/60">
                          <div className="flex items-start space-x-3 flex-1 min-w-0">
                            ...
                            <div className="flex-1 min-w-0">
                              ...
                              {item.category && (
                                <p className="text-gray-500 text-xs mt-1 bg-gray-100 px-2 py-1 rounded-md inline-block">
                                  {item.category}
                                </p>
                              )}
                            </div>
                  ...
                  <div className="p-4 border-b border-gray-200/60">
                    ...
                    <div className="space-y-2 text-sm bg-white p-4 rounded-xl border border-gray-200/60">
                      <div className="flex justify-between py-1">
                        ...
                        <span className="font-semibold">₹{order.pricing?.itemsTotal?.toFixed(2) || order.subtotal?.toFixed(2) || '0.00'}</span>
                      </div>
                      <div className="flex justify-between py-1">
                      ...
                      <div className="flex justify-between py-1">
                        ...
                        <span className="font-semibold">₹{order.pricing?.taxAmount?.toFixed(2) || '0.00'}</span>
                      </div>
                      <div className="flex justify-between font-bold text-gray-900 border-t border-gray-300 pt-2 mt-2 text-base">
                    ...
                    <div className="space-y-3 text-sm bg-white p-4 rounded-xl border border-gray-200/60">
                      ...
                      {order.deliveryZone && (
                        <div className="flex justify-between items-center py-2">
                          ...
                          <span className="font-semibold bg-gray-100 px-3 py-1 rounded-lg text-sm">{order.deliveryZone}</span>
                        </div>
                      )}
                    </div>
                  </div>
                    ...
                    <div className="bg-gradient-to-br from-purple-50 to-purple-100/50 p-4 rounded-xl border border-purple-200/60">
                      <div className="flex items-center justify-between">
                        <div className="flex items-center space-x-3">
                          ...
                          <div>
                            <p className="font-semibold text-purple-900 text-sm">Payment Method</p>
                            <p className="text-purple-700 text-xs mt-0.5">{paymentInfo.displayText}</p>
                          </div>
                        </div>
                        <div className="text-right">
                          <p className="text-purple-900 font-bold text-sm">Amount Due</p>
                ...
                <button
                  ...
                  className="w-full p-4 border-t border-gray-200/60 flex items-center justify-center text-sm font-semibold text-orange-600 hover:bg-orange-50/50 transition-all duration-200 active:bg-orange-100"
                >
        ...
        {filteredOrders.length === 0 && !loading && (
          <div className="text-center py-16 px-4">
            ...
            <div className="flex flex-col sm:flex-row gap-3 justify-center">
              <button
                onClick={handleRefresh}
                className="bg-gradient-to-r from-orange-500 to-orange-600 text-white px-8 py-3.5 rounded-xl hover:shadow-lg transition-all duration-200 font-semibold text-sm active:scale-95"
              >
                Check for New Orders
              </button>
              <button
                onClick={() => navigate('/')}
                className="bg-white border border-gray-300 text-gray-700 px-8 py-3.5 rounded-xl hover:bg-gray-50 transition-all duration-200 font-semibold text-sm active:scale-95"
              >
                Start Shopping
              </button>
            </div>
        ...
        {lastRefreshed && filteredOrders.length > 0 && (
          <div className="text-center pt-8 pb-4">
            <p className="text-xs text-gray-500 bg-white/80 backdrop-blur-lg inline-block px-4 py-2 rounded-full border border-gray-200/60">
