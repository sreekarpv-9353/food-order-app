...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 pb-20"> {/* Added min-h-screen and increased bottom padding */}
      <div className="container mx-auto px-4 py-4">
        ...
        {/* ✅ GROCERY SECTION */}
        {activeTab === 'grocery' && (
          <div className="grid grid-cols-2 gap-3 pb-4"> {/* Added pb-4 for extra bottom padding */}
